...
Add some new variables to the dataset. Add, for every observation, some relevant information about the characteristics of the meteorological bin it belonged to:
...
save(del2p, file="../../data/derived_data/del2p.Rdata")
```
