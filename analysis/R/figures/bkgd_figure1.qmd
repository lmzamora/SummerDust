...
```{r}
eval(parse(t=paste0("lev",l,"[seaice>1, seaice:=NA]")))
eval(parse(t=paste0("la2<-lev",l)))
eval(parse(t=paste0("rm(lev",l,")")))
...
We added the resulting data into one data table:
...
```{r}
save(tog, file="../../data/derived_data/tog.Rdata")
