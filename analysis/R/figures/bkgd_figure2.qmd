...
databoa <- data.frame(
  ...
  month=months_lab,
  dCRE=-CREboa_mos,
  dCREhi=pmax(-CREboa_mos_lo,-CREboa_mos,-CREboa_mos_hi),
  dCRElo=pmin(-CREboa_mos_lo,-CREboa_mos,-CREboa_mos_hi),
  frac_ltn10= frac_ltn10_mos*100,
  mean_fdust= mean_dust_mos,
...
datatoa <- data.frame(
  ...
  month=months_lab,
  dCRE=-CREtoa_mos,
  dCREhi=pmax(-CREtoa_mos_lo,-CREtoa_mos,-CREtoa_mos_hi),
  dCRElo=pmin(-CREtoa_mos_lo,-CREtoa_mos,-CREtoa_mos_hi),
  frac_ltn10= frac_ltn10_mos*100,
  mean_fdust= mean_dust_mos,
  mean_mdust= mean_mdust_mos,
  sza=mean_sza_mos
...
boatoa<-rbind(databoa, datatoa)
```

Save the data set:

```{r}
fwrite(boatoa, file="../../data/derived_data/fig2.csv")
```
