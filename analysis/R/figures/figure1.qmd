...
```{r}
jpeg(file='../../figures/Figure1.jpeg',width=190, height=95, units='mm', res=600, pointsize=8)
layout(matrix(c(1,2,3,4,5), nrow=1, ncol=5), widths=lcm(c(4.75,5.16,0.8,1.16,7.125)), heights=lcm(9.5))
...
points(si_fCmpc,alt,ty="l",col="#fdae61", lwd=5)
points(si_fCice,alt,ty="l",col="#2c7bb6", lwd=5)
legend(53, 4, legend=c("Liquid", "Mixed","Ice"), col=c("#d7191c", "#fdae61", "#2c7bb6"), lty=1:2, lwd=5)
text(80,1.5, substitute(paste(bold('(a)'))), cex=1.5)
