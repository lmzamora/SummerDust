...
For **Figure 1b**, we loaded the following datasets, which represent the estimated dust-driven increases in cloud glaciation in different meteorological conditions and the corresponding dataset that represents whether these differences were significant (p\< 0.05):
