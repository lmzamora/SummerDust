...
load("../../data/derived_data/del2p.RData")
```
...
```{r}
source("/Users/lzamora/Library/CloudStorage/OneDrive-NASA/NASA_Science/8000-5_R+D_project_files/ACMAP3/code/data_analysis/image.scale.2.R")
...
# eval(parse(t=paste0("png('dcP_",atypes[i],"_",var1,"_",var3,"_p_l",k,"_si_v6.png', width=5, height=4, units='in', res=200)")))
...
eval(parse(t=paste0("text(-20,20,'n(cloud profiles) = ",round(sum(del1$alln)/1e6),"M')")))
par(mar=c(1,1,1,3))
