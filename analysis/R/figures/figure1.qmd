...
setDT(del2p)
#grid2<-read.csv("../../data/derived_data/grid2.csv")
#grid2<-as.matrix(grid2[,-1])
#grid2p<-read.csv("../../data/derived_data/grid2p.csv")
#grid2p<-as.matrix(grid2p[,-1])
#sizegrid<-read.csv("../../data/derived_data/sizegrid.csv")
#sizegrid<-as.matrix(sizegrid[,-1])
...
testp<-dcast(del2p, merTbin~merQVbin,value.var='dglaciationp',fun=mean,na.rm=T,fill=NA) #this will cause trouble if there is more than 1 real value, but there shouldn't be.
